...
- **User Story 4 (Phase 6)**: Depends on Phase 2 only (agent-side memory is independent of frontend stories); can start after Phase 2 if desired
...
Phase 2 (Foundational) ──── GATE: blocks all stories
    ...
    ├──────────────────────────────┐
    ▼                              ▼
Phase 3 (US1: First Visit)   Phase 6 (US4: Memory) [V1]
    │  ↳ Personality Gate (P3)     │ (agent-side, can start early)
    │                              │
    ├──────────┐                   │
    ▼          ▼                   │
Phase 4    Phase 5                 │
