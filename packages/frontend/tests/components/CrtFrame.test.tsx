...
describe('CrtFrame', () => {
  it('should render the CRT bezel container', () => {
    render(<CrtFrame><div data-testid="screen-content">Test</div></CrtFrame>);
  ...
  it('should render a screen slot for content', () => {
    render(<CrtFrame><div data-testid="screen-content">Test Content</div></CrtFrame>);
  ...
  it('should apply CRT frame styling class', () => {
    render(<CrtFrame><div>Content</div></CrtFrame>);
